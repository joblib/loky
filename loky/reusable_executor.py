...
class _ReusablePoolExecutor(ProcessPoolExecutor):
    ...
    def get_reusable_executor(cls, max_workers=None, context=None, timeout=10,
        ...
        with _executor_lock:
            ...
            if executor is None:
                is_reused = False
                mp.util.debug("Create a executor with "
                ...
                if (executor._flags.broken or executor._flags.shutdown
                    ...
                    mp.util.debug(
                        "Creating a new executor with "
                        f"max_workers={max_workers} as the previous instance "
                        f"cannot be reused ({reason}).")
                    ...
                    mp.util.debug("Reusing existing executor with "
