...
if sys.version_info[:2] >= (3, 3):
    ...
    # However, allowing workers to die with the interpreter has two undesirable
    # properties: - The workers would still be running during interpreter
    # shutdown, meaning that they would fail in unpredictable ways.  - The
    # workers could be killed while evaluating a work item, which could be bad
    # if the callable being evaluated has external side-effects e.g.  writing
    # to a file.
    #
    ...
    class ThreadPoolExecutor(_base.Executor):
        ...
        def __init__(self, max_workers=None, thread_name_prefix='',
            ...
            Args:
                ...
                thread_name_prefix: An optional name prefix to give our
                    threads.
            ...
            self._work_queue = threading_SimpleQueue()
            self._threads = set()
            self._broken = False
        ...
        def _adjust_thread_count(self):
            ...
            def weakref_cb(_, q=self._work_queue):
                q.put(None)
            # TODO(bquinlan): Should avoid creating new threads if there are
            # more idle threads than items in the work queue.
