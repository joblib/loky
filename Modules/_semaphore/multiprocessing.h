...
PyObject *Semaphore_SetError(PyObject *Type, int num);

/*
 * Externs - not all will really exist on all platforms
 */

extern PyObject *Semaphore_BufferTooShort;
extern PyTypeObject SemaphoreSemLockType;
extern PyObject *Semaphore_semlock_unlink(PyObject *ignore, PyObject *args);
